...
const Toggle = () => (
    <label className="inline-flex items-center cursor-pointer">
        <span className="mr-2 text-sm font-medium text-gray-900 dark:text-gray-300">Manual</span>
        ...
        <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">Automatic</span>
    </label>
)

export const Form = ({children, submit, submitRef}: FormProps) => {
  return (
